...
namespace GenioMVC.Controllers
{
	...
	{
		private static readonly NavigationLocation ACTION_SQB_MENU_51 = new NavigationLocation("TREINOS59076", "SQB_Menu_51", "Treino") { vueRouteName = "menu-SQB_51" };


		//
		// GET: /Treino/SQB_Menu_51
