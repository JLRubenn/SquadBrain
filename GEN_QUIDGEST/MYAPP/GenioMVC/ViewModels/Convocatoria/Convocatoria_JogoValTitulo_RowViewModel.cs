...
public class Convocatoria_JogoValTitulo_RowViewModel : Models.Jogo
{
	#region Constructors

	public Convocatoria_JogoValTitulo_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Convocatoria_JogoValTitulo_RowViewModel(UserContext userContext, CSGenioAjogo val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
