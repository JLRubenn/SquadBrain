	...
	<teleport
		...
		<q-container
			...
			<template v-if="formControl.initialized && showFormBody">
				<q-row v-if="controls.CONVOCATORIA__JOGO__TITULO.isVisible">
					<q-col
						...
						<base-input-structure
							...
							<q-text-field
								...
								@blur="onBlur(controls.CONVOCATORIA__JOGO__TITULO, model.ValTitulo.value)"
	...
	export default {
		...
		data()
		{
			...
			return {
				...
				controls: {
					CONVOCATORIA__JOGO__TITULO: new fieldControlClass.StringControl({
					...
					CONVOCATORIA__PSEUD__CONVOCADOS: new fieldControlClass.TableListControl({
						...
						columnsOriginal: [
							...
							new listColumnTypes.NumericColumn({
								order: 2,
								name: 'Jogador.ValNumerocamisola',
								area: 'JOGADOR',
						...
						globalEvents: ['changed-CONVOCATORIA', 'changed-JOGADOR'],
						uuid: 'Convocatoria_ValConvocados',
						allSelectedRows: 'false',
						controlLimits: [
							{
								identifier: ['id', 'jogo'],
								dependencyEvents: ['fieldChange:jogo.codjogo'],
								dependencyField: 'JOGO.CODJOGO',
								fnValueSelector: (model) => model.ValCodjogo.value
							},
						],
					}, this),
				},
