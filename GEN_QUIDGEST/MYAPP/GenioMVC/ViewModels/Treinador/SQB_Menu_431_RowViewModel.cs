...
public class SQB_Menu_431_RowViewModel : Models.Treinador
{
	#region Constructors

	public SQB_Menu_431_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public SQB_Menu_431_RowViewModel(UserContext userContext, CSGenioAtreinador val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
