...
public class Treino_ValExercicio_RowViewModel : Models.Exercicio
{
	#region Constructors

	public Treino_ValExercicio_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Treino_ValExercicio_RowViewModel(UserContext userContext, CSGenioAexercicio val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
