...
namespace GenioMVC.Controllers
{
	public partial class ExercicioController : ControllerBase
	{
		...
		public ExercicioController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL SQB CONTROLLER_NAVIGATION EXERCICIO]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAexercicio>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL SQB MANUAL_CONTROLLER EXERCICIO]/
		...
		/// <summary>
		/// Recalculate formulas of the "Exercicio" form. (++, CT, SR, CL and U1)
		/// </summary>
		/// <param name="formData">Current form data</param>
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Exercicio([FromBody]Exercicio_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "exercicio",
				(primaryKey) => Models.Exercicio.Find(primaryKey, UserContext.Current, "FEXERCICIO"),
				(model) => formData.MapToModel(model as Models.Exercicio)
			);
		}
		...
		{
			return base.GetDocumsTickets("EXERCICIO", requestModel.FieldName, requestModel.KeyValue);
		}
