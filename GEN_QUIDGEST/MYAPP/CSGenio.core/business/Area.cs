...
namespace CSGenio.business
{
    ...
    {
        public static AreaRef AreaJOGO { get { return m_AreaJOGO; } }
        private static AreaRef m_AreaJOGO = new AreaRef("SQB", "sqbjogo", "jogo");
        public static AreaRef AreaCLUBE { get { return m_AreaCLUBE; } }
        private static AreaRef m_AreaCLUBE = new AreaRef("SQB", "sqbclube", "clube");
        public static AreaRef AreaTREINADOR { get { return m_AreaTREINADOR; } }
        private static AreaRef m_AreaTREINADOR = new AreaRef("SQB", "sqbtreinador", "treinador");
        public static AreaRef AreaS_APR { get { return m_AreaS_APR; } }
        private static AreaRef m_AreaS_APR = new AreaRef("SQB", "asyncprocess", "s_apr");
        public static AreaRef AreaS_NES { get { return m_AreaS_NES; } }
        private static AreaRef m_AreaS_NES = new AreaRef("SQB", "notificationemailsignature", "s_nes");
        public static AreaRef AreaEXERCICIO { get { return m_AreaEXERCICIO; } }
        private static AreaRef m_AreaEXERCICIO = new AreaRef("SQB", "sqbexercicio", "exercicio");
        public static AreaRef AreaS_UA { get { return m_AreaS_UA; } }
        private static AreaRef m_AreaS_UA = new AreaRef("SQB", "userauthorization", "s_ua");
        public static AreaRef AreaJOGADOR { get { return m_AreaJOGADOR; } }
        private static AreaRef m_AreaJOGADOR = new AreaRef("SQB", "sqbjogador", "jogador");
        public static AreaRef AreaPSW { get { return m_AreaPSW; } }
        private static AreaRef m_AreaPSW = new AreaRef("SQB", "userlogin", "psw");
        public static AreaRef AreaCONVOCATORIA { get { return m_AreaCONVOCATORIA; } }
        private static AreaRef m_AreaCONVOCATORIA = new AreaRef("SQB", "sqbconvocatoria", "convocatoria");
        public static AreaRef AreaPRESENCA { get { return m_AreaPRESENCA; } }
        private static AreaRef m_AreaPRESENCA = new AreaRef("SQB", "sqbpresenca", "presenca");
        public static AreaRef AreaS_NM { get { return m_AreaS_NM; } }
        private static AreaRef m_AreaS_NM = new AreaRef("SQB", "notificationmessage", "s_nm");
        public static AreaRef AreaS_PAX { get { return m_AreaS_PAX; } }
        private static AreaRef m_AreaS_PAX = new AreaRef("SQB", "asyncprocessattachments", "s_pax");
        public static AreaRef AreaMEM { get { return m_AreaMEM; } }
        private static AreaRef m_AreaMEM = new AreaRef("SQB", "sqbmem", "mem");
        public static AreaRef AreaS_ARG { get { return m_AreaS_ARG; } }
        private static AreaRef m_AreaS_ARG = new AreaRef("SQB", "asyncprocessargument", "s_arg");
        public static AreaRef AreaTREINO { get { return m_AreaTREINO; } }
        private static AreaRef m_AreaTREINO = new AreaRef("SQB", "sqbtreino", "treino");
        //areas hardcoded
        public static AreaRef AreaDELEGA { get { return m_AreaDELEGA; } }
        private static AreaRef m_AreaDELEGA = new AreaRef("SQBdelega", "delega");
        ...
        private static AreaRef m_AreaMQQUEUES = new AreaRef("SQBmqqueues", "mqqueues");
        ...
        private static AreaRef m_AreaTBLCFG = new AreaRef("SQB", "SQBtblcfg", "tblcfg");
        public static AreaRef AreaLSTUSR { get { return m_AreaLSTUSR; } }
        private static AreaRef m_AreaLSTUSR = new AreaRef("SQBlstusr", "lstusr");
        public static AreaRef AreaLSTCOL { get { return m_AreaLSTCOL; } }
        private static AreaRef m_AreaLSTCOL = new AreaRef("SQBlstcol", "lstcol");
        public static AreaRef AreaUSRCFG { get { return m_AreaUSRCFG; } }
        private static AreaRef m_AreaUSRCFG = new AreaRef("SQBusrcfg", "usrcfg");
        public static AreaRef AreaLSTREN { get { return m_AreaLSTREN; } }
        private static AreaRef m_AreaLSTREN = new AreaRef("SQBlstren", "lstren");
        public static AreaRef AreaUSRWID { get { return m_AreaUSRWID; } }
        private static AreaRef m_AreaUSRWID = new AreaRef("SQBusrwid", "usrwid");
