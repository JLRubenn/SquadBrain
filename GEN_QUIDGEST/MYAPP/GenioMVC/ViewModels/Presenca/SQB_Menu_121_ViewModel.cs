...
{
	public class SQB_Menu_121_ViewModel : MenuListViewModel<Models.Presenca>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("table")]
		public TablePartial<SQB_Menu_121_RowViewModel> Menu { get; set; }
		...
		{
// USE /[MANUAL SQB LIST_LIMITS 121]/
		...
		public SQB_Menu_121_ViewModel() : base(null!) { }

		/// <summary>
		/// Initializes a new instance of the <see cref="SQB_Menu_121_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public SQB_Menu_121_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public SQB_Menu_121_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			Menu ??= new TablePartial<SQB_Menu_121_RowViewModel>();
			...
			{
				// EPH
				crs = Models.Presenca.AddEPH<CSGenioApresenca>(ref u, crs, "ML121");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Presenca.AddEPH<CSGenioApresenca>(ref u, null, "ML121"));
			}
		...
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioApresenca> Qlisting, ref CriteriaSet conditions)
		{
			...
			CriteriaSet sqb_menu_121Conds = CriteriaSet.And();
			...
			conditions.SubSets.Add(sqb_menu_121Conds);
			sqb_menu_121Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
			tableReload &= hasAllRequiredLimits;

// USE /[MANUAL SQB OVERRQ 121]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioApresenca>(m_userContext, false, ref sqb_menu_121Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML121", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL SQB OVERRQLSTEXP 121]/
...
// USE /[MANUAL SQB OVERRQLIST 121]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioApresenca.GetInformation(), QMVC_POS_RECORD, sorts, sqb_menu_121Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
						pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
				}

				ListingMVC<CSGenioApresenca> listing = Models.ModelBase.Where<CSGenioApresenca>(m_userContext, distinct, sqb_menu_121Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML121", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
				...
				Menu.Elements = MapSQB_Menu_121(listing);
		...
		private List<SQB_Menu_121_RowViewModel> MapSQB_Menu_121(ListingMVC<CSGenioApresenca> Qlisting)
		{
			List<SQB_Menu_121_RowViewModel> Elements = [];
			int i = 0;
			...
			if (Qlisting.Rows != null)
			{
				foreach (var row in Qlisting.Rows)
				{
					if (Qlisting.NumRegs > 0 && i >= Qlisting.NumRegs) // Copiado da versão antiga do RowsToViewModels
						break;
					Elements.Add(MapSQB_Menu_121(row));
					i++;
				}
			}
		...
		/// to a SQB_Menu_121_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private SQB_Menu_121_RowViewModel MapSQB_Menu_121(CSGenioApresenca row)
		{
			var model = new SQB_Menu_121_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
...
// USE /[MANUAL SQB VIEWMODEL_CUSTOM SQB_MENU_121]/
