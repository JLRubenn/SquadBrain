...
/**
 * The estado_presenca array.
 */
export class QArrayEstado_presenca
{
	// eslint-disable-next-line @typescript-eslint/no-unused-vars
	constructor(fnResources)
	{
		this.type = 'C'
		this.pluralName = 'ESTADOS_PRESENCAS32503'
		this.singularName = 'ESTADO_PRESENCA27997'

		this.elements = [
			new Option({
				num: 1,
				key: 'P',
				resourceId: 'PRESENTE06127',
				fnResources,
			}),
			new Option({
				num: 2,
				key: 'F',
				resourceId: 'FALTA38383',
				fnResources,
			}),
			new Option({
				num: 3,
				key: 'L',
				resourceId: 'LESAO00772',
				fnResources,
			}),
			new Option({
				num: 4,
				key: 'FJ',
				resourceId: 'FALTA_JUSTIFICADA27443',
				fnResources,
			}),
			new Option({
				num: 5,
				key: 'FI',
				resourceId: 'FALTA_INJUSTIFICADA60425',
				fnResources,
			}),
			new Option({
				num: 6,
				key: 'O',
				resourceId: 'OUTROS19682',
				fnResources,
			}),
			new Option({
				num: 7,
				key: 'A',
				resourceId: 'ATRASO01697',
				fnResources,
			}),
		]
 ...
 * The funcaoTR array.
 */
export class QArrayFuncaotr
{
	// eslint-disable-next-line @typescript-eslint/no-unused-vars
	constructor(fnResources)
	{
		this.type = 'C'
		this.pluralName = 'FUNCOESTR28920'
		this.singularName = 'FUNCAOTR03270'

		this.elements = [
			new Option({
				num: 1,
				key: 'PR',
				resourceId: 'PRINCIPAL25927',
				fnResources,
			}),
			new Option({
				num: 2,
				key: 'ADJ',
				resourceId: 'ADJUNTO08880',
				fnResources,
			}),
		]
 ...
 * The Pe array.
 */
export class QArrayPe
{
	// eslint-disable-next-line @typescript-eslint/no-unused-vars
	constructor(fnResources)
	{
		this.type = 'C'
		this.pluralName = 'PES24199'
		this.singularName = 'PE32606'
 ...
 * The Posicao array.
 */
export class QArrayPosicao
{
	// eslint-disable-next-line @typescript-eslint/no-unused-vars
	constructor(fnResources)
	{
		this.type = 'C'
		this.pluralName = 'POSICOES52720'
		this.singularName = 'POSICAO53364'

		this.elements = [
			new Option({
				num: 1,
				key: 'GR',
				resourceId: 'GUARDA_REDES05920',
				fnResources,
			}),
			new Option({
				num: 2,
				key: 'DEF',
				resourceId: 'DEFESA24828',
				fnResources,
			}),
			new Option({
				num: 3,
				key: 'MD',
				resourceId: 'MEDIO16290',
				fnResources,
			}),
			new Option({
				num: 4,
				key: 'AT',
				resourceId: 'ATACANTE03785',
				fnResources,
			}),
		]
