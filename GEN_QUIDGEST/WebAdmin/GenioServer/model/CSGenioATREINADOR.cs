...
namespace CSGenio.business
{
	...
	/// Treinador
	/// </summary>
	public class CSGenioAtreinador : DbArea
	{
		/// <summary>
		...
		public CSGenioAtreinador(User user, string module)
		{
            this.user = user;
            this.module = module;
			// USE /[MANUAL SQB CONSTRUTOR TREINADOR]/
		}

		public CSGenioAtreinador(User user) : this(user, user.CurrentModule)
		{
		}
...
#pragma warning restore CS0168, S1481 // Variable is declared but never used
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "funcao", FieldType.ARRAY_TEXT);
			Qfield.FieldDescription = "Fun";
			Qfield.FieldSize =  3;
			Qfield.MQueue = false;
			Qfield.CavDesignation = "FUN01176";

			Qfield.Dupmsg = "";
            Qfield.ArrayName = "dbo.GetValArrayCfuncaotr";
            Qfield.ArrayClassName = "Funcaotr";
			info.RegisterFieldDB(Qfield);
		...
		private static void InicializaRelacoes(AreaInfo info)
		{
			...
			info.ParentTables.Add("clube", new Relation("SQB", "sqbtreinador", "treinador", "codtreinador", "codclube", "SQB", "sqbclube", "clube", "codclube", "codclube"));
		}
		...
		private static AreaInfo InicializaAreaInfo()
		{
			...
			info.QSystem="SQB";
			info.TableName="sqbtreinador";
			info.ShadowTabName="";
			info.ShadowTabKeyName="";

			info.PrimaryKeyName="codtreinador";
			info.HumanKeyName="nome,".TrimEnd(',');
			info.Alias="treinador";
			info.IsDomain = true;
			info.PersistenceType = PersistenceType.Database;
			info.AreaDesignation="Treinador";
			info.AreaPluralDesignation="Treinadores";
			info.DescriptionCav="TREINADOR19936";
		...
		private static FieldRef m_fldCodtreinador = new FieldRef("treinador", "codtreinador");
		...
		private static FieldRef m_fldCodclube = new FieldRef("treinador", "codclube");
		...
		private static FieldRef m_fldNome = new FieldRef("treinador", "nome");
		...
		public static FieldRef FldFuncao { get { return m_fldFuncao; } }
		private static FieldRef m_fldFuncao = new FieldRef("treinador", "funcao");

		/// <summary>Field : "Fun" Tipo: "AC" Formula:  ""</summary>
		public string ValFuncao
		{
			get { return (string)returnValueField(FldFuncao); }
        ...
        public static CSGenioAtreinador search(PersistentSupport sp, string key, User user, string[] fields = null, bool forUpdate = false)
        {
			if (string.IsNullOrEmpty(key))
				return null;

		    CSGenioAtreinador area = new CSGenioAtreinador(user, user.CurrentModule);
        ...
        /// <remarks>Persistence operations should not be used on a partially positioned register</remarks>
        public static List<CSGenioAtreinador> searchList(PersistentSupport sp, User user, CriteriaSet where, string[] fields = null, bool distinct = false, bool noLock = false)
        {
				return sp.searchListWhere<CSGenioAtreinador>(where, user, fields, distinct, noLock);
        }
        ...
        /// <returns>A list of area records with all fields populated</returns>
        /// <remarks>Persistence operations should not be used on a partially positioned register</remarks>
        public static void searchListAdvancedWhere(PersistentSupport sp, User user, CriteriaSet where, ListingMVC<CSGenioAtreinador> listing)
        {
			sp.searchListAdvancedWhere<CSGenioAtreinador>(where, listing);
        }
