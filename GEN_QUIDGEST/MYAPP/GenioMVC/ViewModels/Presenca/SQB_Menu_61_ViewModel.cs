...
{
	public class SQB_Menu_61_ViewModel : MenuListViewModel<Models.Presenca>
	{
		/// <summary>
...
// USE /[MANUAL SQB LIST_LIMITS 61]/
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			{
				// EPH
				crs = Models.Presenca.AddEPH<CSGenioApresenca>(ref u, crs, "ML61");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Presenca.AddEPH<CSGenioApresenca>(ref u, null, "ML61"));
			}
...
// USE /[MANUAL SQB OVERRQ 61]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioApresenca>(m_userContext, false, ref sqb_menu_61Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML61", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL SQB OVERRQLIST 61]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioApresenca.GetInformation(), QMVC_POS_RECORD, sorts, sqb_menu_61Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
						pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
				}

				ListingMVC<CSGenioApresenca> listing = Models.ModelBase.Where<CSGenioApresenca>(m_userContext, distinct, sqb_menu_61Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML61", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		private List<SQB_Menu_61_RowViewModel> MapSQB_Menu_61(ListingMVC<CSGenioApresenca> Qlisting)
		{
		...
		private SQB_Menu_61_RowViewModel MapSQB_Menu_61(CSGenioApresenca row)
		{
