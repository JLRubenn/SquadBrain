...
{
	public class SQB_Menu_31_ViewModel : MenuListViewModel<Models.Jogo>
	{
		/// <summary>
		...
		public override string Uuid => "44982ae9-9db2-4d57-aabf-110c6c7b71e6";
...
// USE /[MANUAL SQB LIST_LIMITS 31]/
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			{
				// EPH
				crs = Models.Jogo.AddEPH<CSGenioAjogo>(ref u, crs, "ML31");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Jogo.AddEPH<CSGenioAjogo>(ref u, null, "ML31"));
			}
...
// USE /[MANUAL SQB OVERRQ 31]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAjogo>(m_userContext, false, ref sqb_menu_31Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML31", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL SQB OVERRQLIST 31]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAjogo.GetInformation(), QMVC_POS_RECORD, sorts, sqb_menu_31Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
						pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
				}

				ListingMVC<CSGenioAjogo> listing = Models.ModelBase.Where<CSGenioAjogo>(m_userContext, distinct, sqb_menu_31Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML31", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		private List<SQB_Menu_31_RowViewModel> MapSQB_Menu_31(ListingMVC<CSGenioAjogo> Qlisting)
		{
		...
		private SQB_Menu_31_RowViewModel MapSQB_Menu_31(CSGenioAjogo row)
		{
