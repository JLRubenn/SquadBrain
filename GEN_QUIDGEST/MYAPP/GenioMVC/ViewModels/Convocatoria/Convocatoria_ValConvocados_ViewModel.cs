...
{
	public class Convocatoria_ValConvocados_ViewModel : MenuListViewModel<Models.Jogador>
	{
		/// <summary>
...
// USE /[MANUAL SQB LIST_LIMITS CONVOCATORIA_PSEUDCONVOCADOS]/
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			{
				// EPH
				crs = Models.Jogador.AddEPH<CSGenioAjogador>(ref u, crs, "IBL_CONVOCATORIA__PSEUD__CONVOCADOS");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Jogador.AddEPH<CSGenioAjogador>(ref u, null, "IBL_CONVOCATORIA__PSEUD__CONVOCADOS"));
			}
		...
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAjogador> Qlisting, ref CriteriaSet conditions)
		{
			...
			FieldRef[] fields = new FieldRef[] { CSGenioAjogador.FldCodjogador, CSGenioAjogador.FldZzstate, CSGenioAjogador.FldNumerocamisola, CSGenioAjogador.FldNome };
			...
			if (sorts.Count == 0)
			{
				...
				firstVisibleColumn ??= new FieldRef("jogador", "numerocamisola");
			}
			// Limitations
			this.TableLimits ??= [];
...
// USE /[MANUAL SQB OVERRQ CONVOCATORIA_PSEUDCONVOCADOS]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAjogador>(m_userContext, false, ref convocatoria__pseud__convocadosConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_CONVOCATORIA__PSEUD__CONVOCADOS", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL SQB OVERRQLIST CONVOCATORIA_PSEUDCONVOCADOS]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAjogador.GetInformation(), QMVC_POS_RECORD, sorts, convocatoria__pseud__convocadosConds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
		...
		private List<Convocatoria_ValConvocados_RowViewModel> MapConvocatoria_ValConvocados(ListingMVC<CSGenioAjogador> Qlisting)
		{
		...
		private Convocatoria_ValConvocados_RowViewModel MapConvocatoria_ValConvocados(CSGenioAjogador row)
		{
...
// USE /[MANUAL SQB VIEWMODEL_CUSTOM CONVOCATORIA_VALCONVOCADOS]/
		...
		[
			"Jogador", "Jogador.ValCodjogador", "Jogador.ValZzstate", "Jogador.ValNumerocamisola", "Jogador.ValNome", "Jogador.ValCodclube"
		];
