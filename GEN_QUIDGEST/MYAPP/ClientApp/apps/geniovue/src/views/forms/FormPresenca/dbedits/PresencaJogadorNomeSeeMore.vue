<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-presenca-jogador-nome-body">
		<q-row>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['PRESENCA__JOGADOR__NOME_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'PresencaJogadorNomeSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('PRESENCA__JOGADOR__NOME_SeeMore', false),

				interfaceMetadata: {
					id: 'PRESENCA__JOGADOR__NOME_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'PRESENCA__JOGADOR__NOME_SeeMore',
					name: 'PRESENCA__JOGADOR__NOME_SeeMore',
					controller: 'PRESENCA',
					action: 'PRESENCA_JogadorValNome'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-presenca-jogador-nome',
				dismissAction: this.close,
				returnElement: 'PRESENCA__JOGADOR__NOME_see-more_button'
			}
			const props = {
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-presenca-jogador-nome')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Presenca_Presenca_JogadorValNome',
