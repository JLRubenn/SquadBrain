...
{
	public class Convocatoria_ViewModel : FormViewModel<Models.Convocatoria>, IPreparableForSerialization
	{
		[JsonIgnore]
		...
		public Convocatoria_ViewModel(UserContext userContext, Models.Convocatoria row, bool nestedForm = false) : base(userContext, "FCONVOCATORIA", row, nestedForm) { }
		...
		public Convocatoria_ViewModel(UserContext userContext, string id, bool nestedForm = false, string[]? fieldsToLoad = null) : this(userContext, nestedForm)
		{
			...
			Model = Models.Convocatoria.Find(id, userContext, "FCONVOCATORIA", fieldsToQuery: fieldsToLoad);
			if (Model == null)
		...
		public static StatusMessage InsertConditions(UserContext userContext)
		{
			...
			Models.Convocatoria model = new Models.Convocatoria(userContext) { Identifier = "FCONVOCATORIA" };
		...
		public override void MapFromModel(Models.Convocatoria m)
		{
			if (m == null)
			{
				CSGenio.framework.Log.Error("Map Model (Convocatoria) to ViewModel (Convocatoria) - Model is a null reference");
				throw new ModelNotFoundException("Model not found");
			}
			...
			{
				CSGenio.framework.Log.Error("Map Model (Convocatoria) to ViewModel (Convocatoria) - Error during mapping");
				throw;
			}
		}
		...
		public override void MapToModel(Models.Convocatoria m)
		{
			if (m == null)
			{
				CSGenio.framework.Log.Error("Map ViewModel (Convocatoria) to Model (Convocatoria) - Model is a null reference");
				throw new ModelNotFoundException("Model not found");
			}
			...
			{
				CSGenio.framework.Log.Error($"Map ViewModel (Convocatoria) to Model (Convocatoria) - Error during mapping. All user values: {HasDisabledUserValuesSecurity}");
				throw;
			}
		}
		...
		{
			try { Model = Models.Convocatoria.Find(id ?? Navigation.GetStrValue("convocatoria"), m_userContext, "FCONVOCATORIA"); }
			finally { Model ??= new Models.Convocatoria(m_userContext) { Identifier = "FCONVOCATORIA" }; }
		...
		public override void Load(NameValueCollection qs, bool editable, bool ajaxRequest = false, bool lazyLoad = false)
		{
			...
			try
			{
				Model = Models.Convocatoria.Find(Navigation.GetStrValue("convocatoria"), m_userContext, "FCONVOCATORIA");
			}
			finally
			{
				if (Model == null)
		...
		public override void LoadPartial(NameValueCollection qs, bool lazyLoad = false)
		{
			...
			if (Model == null)
			{
				...
				if (Model == null)
				{
					Model = new Models.Convocatoria(m_userContext) { Identifier = "FCONVOCATORIA" };
...
// USE /[MANUAL SQB VIEWMODEL_DESTROY CONVOCATORIA]/
		...
		{
			Model = Models.Convocatoria.Find(id, m_userContext, "FCONVOCATORIA");
			if (Model == null)
				throw new ModelNotFoundException("Model not found");
