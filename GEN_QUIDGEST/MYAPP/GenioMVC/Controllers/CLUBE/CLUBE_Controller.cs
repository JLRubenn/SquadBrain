...
namespace GenioMVC.Controllers
{
	public partial class ClubeController : ControllerBase
	{
		...
		public ClubeController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL SQB CONTROLLER_NAVIGATION CLUBE]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAclube>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL SQB MANUAL_CONTROLLER CLUBE]/
		...
		/// <summary>
		/// Recalculate formulas of the "Clube" form. (++, CT, SR, CL and U1)
		/// </summary>
		/// <param name="formData">Current form data</param>
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Clube([FromBody]Clube_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "clube",
				(primaryKey) => Models.Clube.Find(primaryKey, UserContext.Current, "FCLUBE"),
				(model) => formData.MapToModel(model as Models.Clube)
			);
		}
		...
		{
			return base.GetDocumsTickets("CLUBE", requestModel.FieldName, requestModel.KeyValue);
		}
