<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-convocatoria-jogo-titulo-body">
		<q-row>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['CONVOCATORIA__JOGO__TITULO_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'ConvocatoriaJogoTituloSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('CONVOCATORIA__JOGO__TITULO_SeeMore', false),

				interfaceMetadata: {
					id: 'CONVOCATORIA__JOGO__TITULO_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'CONVOCATORIA__JOGO__TITULO_SeeMore',
					name: 'CONVOCATORIA__JOGO__TITULO_SeeMore',
					controller: 'CONVOCATORIA',
					action: 'CONVOCATORIA_JogoValTitulo'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-convocatoria-jogo-titulo',
				dismissAction: this.close,
				returnElement: 'CONVOCATORIA__JOGO__TITULO_see-more_button'
			}
			const props = {
				class: 'q-dialog-see-more',
				title: computed(() => this.Resources.JOGOS19503),
				buttons: [
					{
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-convocatoria-jogo-titulo')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						config: {
							name: 'Convocatoria_JogoValTitulo',
							serverMode: true,
							pkColumn: 'ValCodjogo',
							tableAlias: 'JOGO',
							...
							defaultColumnSorting: {
								columnName: 'ValTitulo',
								sortOrder: 'asc'
							}
						},
						globalEvents: ['changed-CLUBE', 'changed-JOGO'],
						uuid: 'Convocatoria_Convocatoria_JogoValTitulo',
