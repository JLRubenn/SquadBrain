...
namespace GenioMVC.Controllers
{
	...
	{
		private static readonly NavigationLocation ACTION_SQB_MENU_51 = new NavigationLocation("PRESENCAS23345", "SQB_Menu_51", "Presenca") { vueRouteName = "menu-SQB_51" };


		//
		// GET: /Presenca/SQB_Menu_51
