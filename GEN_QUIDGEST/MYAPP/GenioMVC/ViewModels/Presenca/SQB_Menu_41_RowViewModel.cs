...
public class SQB_Menu_41_RowViewModel : Models.Presenca
{
	#region Constructors
	...
	public SQB_Menu_41_RowViewModel(UserContext userContext, CSGenioApresenca val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
