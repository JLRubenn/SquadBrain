...
// USE /[MANUAL SQB LIST_LIMITS 21]/
		...
		public override int GetCount(User user)
		{
			...
			FieldRef[] fields = new FieldRef[] { CSGenioAjogador.FldCodjogador, CSGenioAjogador.FldZzstate, CSGenioAjogador.FldEquipaanterior, CSGenioAjogador.FldPedominante, CSGenioAjogador.FldNome, CSGenioAjogador.FldNumerocamisola, CSGenioAjogador.FldFoto, CSGenioAjogador.FldPosicao, CSGenioAjogador.FldDatanascimento, CSGenioAjogador.FldCodclube, CSGenioAclube.FldCodclube, CSGenioAclube.FldNome, CSGenioAjogador.FldPosicaosegundaria };
		...
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAjogador> Qlisting, ref CriteriaSet conditions)
		{
			...
			allSortOrders.Add("JOGADOR.EQUIPAANTERIOR", new OrderedDictionary());
			allSortOrders["JOGADOR.EQUIPAANTERIOR"].Add("JOGADOR.EQUIPAANTERIOR", "A");
			...
			if (sorts == null || sorts.Count == 0)
			{
				...
				sorts.Add(new ColumnSort(new ColumnReference(CSGenioAjogador.FldEquipaanterior), SortOrder.Ascending));
			...
			if (sorts.Count == 0)
			{
				...
				firstVisibleColumn ??= new FieldRef("jogador", "equipaanterior");
			}
			// Limitations
			this.TableLimits ??= [];
...
// USE /[MANUAL SQB VIEWMODEL_CUSTOM SQB_MENU_21]/
		...
		[
			"Jogador", "Jogador.ValCodjogador", "Jogador.ValZzstate", "Jogador.ValEquipaanterior", "Jogador.ValPedominante", "Jogador.ValNome", "Jogador.ValNumerocamisola", "Jogador.ValFoto", "Jogador.ValPosicao", "Jogador.ValDatanascimento", "Clube", "Clube.ValNome", "Jogador.ValPosicaosegundaria", "Jogador.ValCodclube"
		];
