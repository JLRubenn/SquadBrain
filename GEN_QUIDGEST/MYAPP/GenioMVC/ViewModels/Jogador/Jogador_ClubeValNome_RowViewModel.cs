...
public class Jogador_ClubeValNome_RowViewModel : Models.Clube
{
	#region Constructors

	public Jogador_ClubeValNome_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Jogador_ClubeValNome_RowViewModel(UserContext userContext, CSGenioAclube val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
