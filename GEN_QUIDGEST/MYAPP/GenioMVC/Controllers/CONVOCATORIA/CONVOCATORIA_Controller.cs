...
namespace GenioMVC.Controllers
{
	public partial class ConvocatoriaController : ControllerBase
	{
		...
		public ConvocatoriaController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL SQB CONTROLLER_NAVIGATION CONVOCATORIA]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAconvocatoria>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL SQB MANUAL_CONTROLLER CONVOCATORIA]/
		...
		public JsonResult ReloadDBEdit([FromBody]RequestReloadDBEditModel requestModel)
		{
			...
			*/
			Models.Convocatoria row = new Models.Convocatoria(UserContext.Current, isEmpty: true);
			row.klass.QPrimaryKey = Navigation.GetStrValue("convocatoria");
					...
					case "CONVOCATORIA__JOGO__TITULO":	// Field (DB)
						{
							...
							model.MapFromModel(row);
							model.Load_Convocatoria__jogo__titulo(qs);
							result = model.TableJogoTitulo;
						}
						break;
					default:
						break;
		...
		{
			return GenericRecalculateFormulas(formData, "convocatoria",
				(primaryKey) => Models.Convocatoria.Find(primaryKey, UserContext.Current, "FCONVOCATORIA"),
				(model) => formData.MapToModel(model as Models.Convocatoria)
			);
		}
		...
		{
			return base.GetDocumsTickets("CONVOCATORIA", requestModel.FieldName, requestModel.KeyValue);
		}
