...
SET @SQL = N'
CREATE DATABASE [ASPStateSQB]
 CONTAINMENT = NONE
 ON  PRIMARY 
	(NAME = N''ASPStateSQB'', FILENAME = N''' + @SQLDataFolder + 'ASPStateSQB.mdf'' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB ), 
 FILEGROUP [ASPStateSQB_mod] CONTAINS MEMORY_OPTIMIZED_DATA  DEFAULT
	(NAME = N''ASPStateSQB_mod'', FILENAME = N''' + @SQLLogFolder + 'ASPStateSQB_mod'' , MAXSIZE = UNLIMITED)
 LOG ON 
	(NAME = N''ASPStateSQB_log'', FILENAME = N''' + @SQLLogFolder + 'ASPStateSQB_log.ldf'' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB );

ALTER DATABASE [ASPStateSQB] SET COMPATIBILITY_LEVEL = 130; ALTER DATABASE [ASPStateSQB] SET MEMORY_OPTIMIZED_ELEVATE_TO_SNAPSHOT=ON;'
