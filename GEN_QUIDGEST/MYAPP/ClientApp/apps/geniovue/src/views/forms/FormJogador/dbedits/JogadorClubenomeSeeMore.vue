<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-jogador-clubenome-body">
		<q-row>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['JOGADOR_CLUBENOME_____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'JogadorClubenomeSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('JOGADOR_CLUBENOME_____SeeMore', false),

				interfaceMetadata: {
					id: 'JOGADOR_CLUBENOME_____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'JOGADOR_CLUBENOME_____SeeMore',
					name: 'JOGADOR_CLUBENOME_____SeeMore',
					controller: 'JOGADOR',
					action: 'JOGADOR_ClubeValNome'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-jogador-clubenome',
				dismissAction: this.close,
				returnElement: 'JOGADOR_CLUBENOME_____see-more_button'
			}
			const props = {
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-jogador-clubenome')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Jogador_Jogador_ClubeValNome',
