...
namespace CSGenio.framework
{
	...
	public class Role
	{
        ...
        public static readonly Role ROLE_30; //Jogador
        public static readonly Role ROLE_40; //Dirigente
        public static readonly Role ROLE_50; //Treinador
        //Roles
		...
		static Role()
		{
            ...
            ROLE_30 = new Role(LevelAccess.NV30, "JOGADOR34905");
            ALL_ROLES.Add("30", ROLE_30);

            ROLE_40 = new Role(LevelAccess.NV40, "DIRIGENTE54986");
            ALL_ROLES.Add("40", ROLE_40);

            ROLE_50 = new Role(LevelAccess.NV50, "TREINADOR19936");
