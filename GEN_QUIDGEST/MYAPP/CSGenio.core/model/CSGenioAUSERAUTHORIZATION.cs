...
namespace CSGenio.business
{
	...
	public class CSGenioAuserauthorization : DbArea
	{
		...
		private static AreaInfo InicializaAreaInfo()
		{
			...
			info.ParentTables.Add("psw", new Relation("SQB", "userauthorization", "userauthorization", "codua", "codpsw", "SQB", "userlogin", "psw", "codpsw", "codpsw"));
		...
		// USE /[MANUAL SQB TABAUX UserAuthorization]/
