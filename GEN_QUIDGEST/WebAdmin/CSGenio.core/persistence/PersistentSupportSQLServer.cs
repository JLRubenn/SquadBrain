    ...
    public class PersistentSupportSQLServer : PersistentSupport
    {
        ...
        public override void transferMSMQLog(bool all)
        {
            ...
            if (!all && Configuration.MaxLogRowDays > 0)
            {
                ...
                filterMQQueues.LesserOrEqual("SQBMQQueues_History", "DATASTATUS", lastDate);
            }
                ...
                using (System.Data.SqlClient.SqlTransaction logTransaction = (System.Data.SqlClient.SqlTransaction)this.Connection.BeginTransaction())
                {
                    try
                    {
                        ...
                        SelectQuery query = new SelectQuery()
                            .Select("SQBMQQueues_History", "CODMQQUEUES", "CODMQQUEUES")
                            .Select("SQBMQQueues_History", "QUEUEID", "QUEUEID")
							.Select("SQBMQQueues_History", "CHANNELID", "CHANNELID")
                            .Select("SQBMQQueues_History", "ANO", "ANO")
                            .Select("SQBMQQueues_History", "USERNAME", "USERNAME")
                            .Select("SQBMQQueues_History", "TABELA", "TABELA")
                            .Select("SQBMQQueues_History", "TABELACOD", "TABELACOD")
                            .Select("SQBMQQueues_History", "QUEUEKEY", "QUEUEKEY")
                            .Select("SQBMQQueues_History", "QUEUE", "QUEUE")
                            .Select("SQBMQQueues_History", "MQSTATUS", "MQSTATUS")
                            .Select("SQBMQQueues_History", "DATASTATUS", "DATASTATUS")
                            .Select("SQBMQQueues_History", "DATACRIA", "DATACRIA")
                            .Select("SQBMQQueues_History", "OPERACAO", "OPERACAO")
                            .Select("SQBMQQueues_History", "RESPOSTA", "RESPOSTA")
                            .Select("SQBMQQueues_History", "SENDNUMBER", "SENDNUMBER")
                            .Select("SQBMQQueues_History", "ZZSTATE", "ZZSTATE")
                            .From("SQBMQQueues_History")
                            .Where(filterMQQueues)
                            .OrderBy("SQBMQQueues_History", "DATACRIA", Quidgest.Persistence.GenericQuery.SortOrder.Ascending);
                        ...
                        using (IDataReader dr = command.ExecuteReader())
                        {
                            ...
                            using (System.Data.SqlClient.SqlBulkCopy bulkCopy = new System.Data.SqlClient.SqlBulkCopy(
                                ...
                                logTransaction))
                            {
                                bulkCopy.DestinationTableName = "dbo.SQBMQQueues_History";
