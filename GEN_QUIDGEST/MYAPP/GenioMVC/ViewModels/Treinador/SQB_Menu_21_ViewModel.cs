...
{
	public class SQB_Menu_21_ViewModel : MenuListViewModel<Models.Treinador>
	{
		/// <summary>
		...
		public override string Uuid => "5ba0ff1b-89f5-40ca-8277-e6289e6181e5";
...
// USE /[MANUAL SQB LIST_LIMITS 21]/
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			{
				// EPH
				crs = Models.Treinador.AddEPH<CSGenioAtreinador>(ref u, crs, "ML21");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Treinador.AddEPH<CSGenioAtreinador>(ref u, null, "ML21"));
			}
...
// USE /[MANUAL SQB OVERRQ 21]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAtreinador>(m_userContext, false, ref sqb_menu_21Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML21", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL SQB OVERRQLIST 21]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAtreinador.GetInformation(), QMVC_POS_RECORD, sorts, sqb_menu_21Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
						pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
				}

				ListingMVC<CSGenioAtreinador> listing = Models.ModelBase.Where<CSGenioAtreinador>(m_userContext, distinct, sqb_menu_21Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML21", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		private List<SQB_Menu_21_RowViewModel> MapSQB_Menu_21(ListingMVC<CSGenioAtreinador> Qlisting)
		{
		...
		private SQB_Menu_21_RowViewModel MapSQB_Menu_21(CSGenioAtreinador row)
		{
