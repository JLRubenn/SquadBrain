...
namespace GenioMVC.Controllers
{
	public partial class JogoController : ControllerBase
	{
		...
		public JogoController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL SQB CONTROLLER_NAVIGATION JOGO]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAjogo>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL SQB MANUAL_CONTROLLER JOGO]/
		...
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Jogo([FromBody]Jogo_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "jogo",
				(primaryKey) => Models.Jogo.Find(primaryKey, UserContext.Current, "FJOGO"),
		...
		{
			return base.GetDocumsTickets("JOGO", requestModel.FieldName, requestModel.KeyValue);
		}
